...
/**
 * This class represents a client for interacting with the Mlchain Chat API.
 * It provides methods for creating, retrieving, and managing chat messages and conversations.
 */
public class ChatClient extends MlchainClient {
     ...
     */
    public Response createChatMessage(String inputs, String query, String user, boolean stream, String conversation_id) throws MlchainClientException {
     ...
     * @throws MlchainClientException If an error occurs while sending the request.
     */
    public Response getConversationMessages(String user, String conversation_id, String first_id, int limit) throws MlchainClientException {
     ...
     * @throws MlchainClientException If an error occurs while sending the request.
     */
    public Response getConversations(String user, String first_id, int limit, String pinned) throws MlchainClientException {
        Map<String, String> queryParams = new HashMap<>();
        queryParams.put("user", user);
     ...
     * @throws MlchainClientException If an error occurs while sending the request.
     */
    public Response renameConversation(String conversation_id, String name, String user) throws MlchainClientException {
        JSONObject json = new JSONObject();
        json.put("name", name);
        json.put("user", user);
     ...
     * @throws MlchainClientException If an error occurs while sending the request.
     */
    public Response deleteConversation(String conversation_id, String user) throws MlchainClientException {
        JSONObject json = new JSONObject();
        json.put("user", user);
