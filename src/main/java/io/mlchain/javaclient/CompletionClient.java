...
/**
 * This class represents a client for interacting with the Mlchain Completion API.
 * It provides methods for creating completion messages using the API.
 */
public class CompletionClient extends MlchainClient {
    /**
     ...
     */
    public Response createCompletionMessage(String inputs, String query, String user, boolean stream) throws MlchainClientException {
